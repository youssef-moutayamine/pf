    ...
    return (
        <section ref={sectionRef} id="portfolio" className="py-24 bg-white dark:bg-black overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Projects Slider with AOS animation */}
                <div 
                    ref={sliderRef} 
                    data-aos="fade-up" 
                    data-aos-duration="800" 
                ...
                >
                        ...
                        {projects.map((project, index) => (
                            <div key={project.id} className="w-full flex-shrink-0 px-4">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                    {/* Project Content with staggered animation */}
                                    <div 
                                        data-aos="fade-right" 
                                        data-aos-duration="800" 
                                    ...
                                    >
                                        ...
                                        <h3 
                                            ...
                                            className="text-4xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-100 leading-tight"
                                        >
                                            {project.title}
                                        </h3>
                                        <p 
                                        ...
                                        <a 
                                            ...
                                            className="inline-flex items-center gap-2 px-8 py-4 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 text-lg hover:shadow-lg"
                                        >
                                            View project →
                                        </a>
                                    </div>
                                    
                                    {/* Project Image with slide-in animation */}
                                    <div 
                                        data-aos="fade-left" 
                                        data-aos-duration="800" 
                                        data-aos-delay={800 + (index * 100)}
                                                ...
                                                <div className="bg-neutral-900 rounded-xl p-4 relative overflow-hidden">
                                                    ...
                                                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                                                        <a 
                                                            ...
                                                            target="_blank"
                                                            rel="noopener noreferrer"
                                                            className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-red-500 transition-colors duration-300 hover:scale-110 transform"
                                                        >
                    ...
                    {/* Navigation Buttons with fade-in animation */}
                    <button 
                        onClick={prevSlide}
                        data-aos="fade-right" 
                        data-aos-duration="600" 
                        data-aos-delay="1200"
                        className="absolute left-2 md:-left-16 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white dark:bg-neutral-800 rounded-full shadow-lg flex items-center justify-center hover:bg-red-50 dark:hover:bg-neutral-700 transition-all duration-300 group z-10 hover:scale-110"
                    >
                    ...
                    <button 
                        ...
                        data-aos-duration="600" 
                        data-aos-delay="1200"
                        className="absolute right-2 md:-right-16 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white dark:bg-neutral-800 rounded-full shadow-lg flex items-center justify-center hover:bg-red-50 dark:hover:bg-neutral-700 transition-all duration-300 group z-10 hover:scale-110"
                    >
                        <svg className="w-5 h-5 md:w-6 md:h-6 text-neutral-600 dark:text-neutral-300 group-hover:text-red-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Slide Indicators with fade-in animation */}
                    <div 
                        data-aos="fade-in" 
                        data-aos-duration="800" 
                        data-aos-delay="1400"
