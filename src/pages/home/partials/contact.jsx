        ...
        <section ref={sectionRef} id="contact" className="py-24 px-6 bg-white dark:bg-black relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    <h2 ref={headerRef} className="text-4xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-100 mb-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    <div ref={leftRef} className="space-y-8">
                        <div className="bg-neutral-100/80 dark:bg-neutral-900/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 w-full min-w-0">
                            <h3 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-6">Get in Touch</h3>
                            ...
                            <div className="mt-8 pt-8 border-t border-neutral-200 dark:border-neutral-800">
                                ...
                                <div className="flex gap-4">
                                    <a href="https://x.com/Youssef_MTN" className="w-10 h-10 bg-red-100 dark:bg-red-900/50 rounded-full flex items-center justify-center hover:bg-red-200 dark:hover:bg-red-900 transition-colors group">
                                    ...
                                    <a href="https://www.linkedin.com/in/youssef-moutayamine-25594b368?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="w-10 h-10 bg-red-100 dark:bg-red-900/50 rounded-full flex items-center justify-center hover:bg-red-200 dark:hover:bg-red-900 transition-colors group">
                                        <svg className="w-5 h-5 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                        </svg>
                                    </a>
                                    <a href="https://github.com/youssef-moutayamine" className="w-10 h-10 bg-red-100 dark:bg-red-900/50 rounded-full flex items-center justify-center hover:bg-red-200 dark:hover:bg-red-900 transition-colors group">
                                        <svg className="w-5 h-5 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div ref={rightRef} className="bg-neutral-50/80 dark:bg-neutral-900/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                        <h3 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-6">Send Message</h3>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 focus:border-red-400 focus:ring-2 focus:ring-red-900 focus:outline-none transition-all duration-200"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    required
                                    rows="4"
                                    className="w-full px-4 py-3 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 focus:border-red-400 focus:ring-2 focus:ring-red-900 focus:outline-none transition-all duration-200 resize-none"
